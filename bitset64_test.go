...
func TestBitset64Contains(t *testing.T) {
	set := New64(SIZE)
...
func TestBitset64Remove(t *testing.T) {
	set := New64(SIZE)
	for i := uint64(0); i < SIZE; i++ {
		set.Add(i)
	}
...
func TestBitset64Enumerate(t *testing.T) {
	set := New64(10)
...
func TestBit64setUnion(t *testing.T) {
	a := New64(15)
	b := New64(15)
	c := New64(15)
	for i := uint64(0); i < 10; i++ {
...
func TestBitset64Intersection(t *testing.T) {
	a := New64(15)
	b := New64(15)
	c := New64(15)
	for i := uint64(0); i < 10; i++ {
...
func TestBitset64Difference(t *testing.T) {
	a := New64(15)
	b := New64(15)
	c := New64(15)
	for i := uint64(0); i < 10; i++ {
