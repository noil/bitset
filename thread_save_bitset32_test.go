...
func TestBitsetThreadSave32Contains(t *testing.T) {
	set := NewThreadSave32(SIZE)
...
func TestBitsetThreadSave32Remove(t *testing.T) {
	set := NewThreadSave32(SIZE)
	for i := uint32(0); i < SIZE; i++ {
		set.Add(i)
	}
...
func TestBitsetThreadSave32Enumerate(t *testing.T) {
	set := NewThreadSave32(10)
...
func TestBitThreadSaveset32Union(t *testing.T) {
	a := NewThreadSave32(15)
	b := NewThreadSave32(15)
	c := NewThreadSave32(15)
	for i := uint32(0); i < 10; i++ {
		a.Add(i)
	}
...
func TestBitsetThreadSave32Intersection(t *testing.T) {
	a := NewThreadSave32(15)
	b := NewThreadSave32(15)
	c := NewThreadSave32(15)
	for i := uint32(0); i < 10; i++ {
...
func TestBitsetThreadSave32Difference(t *testing.T) {
	a := NewThreadSave32(15)
	b := NewThreadSave32(15)
	c := NewThreadSave32(15)
	for i := uint32(0); i < 10; i++ {
